...
describe Document do
  ...
  describe "#metadata" do
    ...
    context 'metadata as linked content' do
      ...
      before do
        facet_1 = Facet.new('key' => :link_values, 'name' => 'Link values')
        facet_2 = Facet.new('key' => :other_link_values, 'name' => 'Other link values')
      ...
      it 'returns facet data' do
        expect(subject.facet_data[0]).to eq(
          key: :link_values,
      ...
      it 'returns facet data for `Other link values`' do
        expect(subject.facet_data[1]).to eq(
