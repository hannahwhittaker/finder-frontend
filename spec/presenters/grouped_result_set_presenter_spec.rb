...
RSpec.describe GroupedResultSetPresenter do
  ...
  describe "#grouped_documents" do
    ...
    def build_document_list_component(document, all_documents_count)
      SearchResultPresenter.new(document: document, metadata_presenter_class: metadata_presenter_class, doc_count: all_documents_count, finder_name: finder_name, debug_score: false, highlight: false).document_list_component_data
    end
