...
RSpec.describe SearchResultPresenter do
  ...
  let(:finder_presenter) {
    double(FinderPresenter, name: finder_name)
  }
  ...
  describe "subtext" do
    ...
    it "returns 'Published by' text if is_historic is true" do
      with_historic = SearchResultPresenter.new(document: document_with_metadata, metadata_presenter_class: metadata_presenter_class, doc_index: doc_index, doc_count: doc_count, finder_presenter: finder_presenter, debug_score: debug_score, highlight: highlight)
    ...
    it "returns debug metadata if debug_score" do
      with_debug = SearchResultPresenter.new(document: document, metadata_presenter_class: metadata_presenter_class, doc_index: doc_index, doc_count: doc_count, finder_presenter: finder_presenter, debug_score: 1, highlight: highlight)
    ...
    it "returns 'Published by' and debug metadata together" do
      with_all = SearchResultPresenter.new(document: document_with_metadata, metadata_presenter_class: metadata_presenter_class, doc_index: doc_index, doc_count: doc_count, finder_presenter: finder_presenter, debug_score: 1, highlight: highlight)
  ...
  describe "summary_text" do
    it "returns summary if not highlighted" do
      no_highlight = SearchResultPresenter.new(document: document, metadata_presenter_class: metadata_presenter_class, doc_index: doc_index, doc_count: doc_count, finder_presenter: finder_presenter, debug_score: debug_score, highlight: false)
    ...
    it "returns truncated summary if highlighted" do
      with_highlight = SearchResultPresenter.new(document: document, metadata_presenter_class: metadata_presenter_class, doc_index: doc_index, doc_count: doc_count, finder_presenter: finder_presenter, debug_score: debug_score, highlight: true)
  ...
  describe "highlight_text" do
    ...
    it "returns 'Most relevant result' if highlight" do
      no_highlight = SearchResultPresenter.new(document: document, metadata_presenter_class: metadata_presenter_class, doc_index: doc_index, doc_count: doc_count, finder_presenter: finder_presenter, debug_score: debug_score, highlight: true)
